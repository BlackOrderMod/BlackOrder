...
set ADDONS=P:\Z\BlackOrder\addons
set OPTIONAL=P:\Z\BlackOrder\optional

set TOOL="C:\tools\six-arma-tools.exe"
set OPTS=-b

set KEY="P:\!keys\BlackOrder.biprivatekey
set SIGN="D:\Program\Steam\steamapps\common\Arma 3 Tools\DSSignFile\DSSignFile.exe"
