            ...
            class Infantry {
                ...
                class O_BlackOrder_InfSquad {
                    ...
                    class Unit0 {
                        ...
                        rank = "SERGEANT";
                        side = 0;
                        vehicle = "O_BlackOrder_SquadLeader_F";
                    };
                    class Unit1 {
                        position[] = {5,-5,0};
                        rank = "PRIVATE";
                    ...
                    class Unit3 {
                        ...
                        rank = "PRIVATE";
                        side = 0;
                        vehicle = "O_BlackOrder_Autorifleman_F";
                    };
                    class Unit4 {
                        position[] = {-10,-10,0};
                        rank = "SERGEANT";
                        side = 0;
                        vehicle = "O_BlackOrder_TeamLeader_F";
                    };
                    class Unit5 {
                        position[] = {15,-15,0};
                        rank = "CORPORAL";
                    ...
                    class Unit7 {
                        ...
                        rank = "PRIVATE";
                        side = 0;
                        vehicle = "O_BlackOrder_CombatLifeSaver_F";
                    };
                };
                class O_BlackOrder_InfSquad_Weapons {
                    ...
                    class Unit7 {
                        ...
                        rank = "PRIVATE";
                        side = 0;
                        vehicle = "O_BlackOrder_Marksmen_F";
                    };
                };
                class O_BlackOrder_InfAssault {
                    name = CSTRING(Group_InfAssault_Display);
                    icon = "\A3\ui_f\data\map\markers\nato\o_inf.paa";
                    faction = "OPF_BlackOrder_F";
                    side = 0;
                    class Unit0 {
                    ...
                    class Unit2 {
                        ...
                        rank = "CORPORAL";
                        side = 0;
                        vehicle = "O_BlackOrder_RadioOperator_F";
                    };
                    class Unit3 {
                        position[] = {10,-10,0};
                        rank = "SERGEANT";
                ...
                class O_BlackOrder_InfTeam_AA {
                    ...
                    class Unit1 {
                        ...
                        rank = "CORPORAL";
                        side = 0;
                        vehicle = "O_BlackOrder_Soldier_AA_F";
                    };
                    class Unit2 {
                        position[] = {-5,-5,0};
                        rank = "PRIVATE";
                ...
                class O_BlackOrder_InfSentryLight {
                    name = CSTRING(Group_InfSentryLight_Display);
                    icon = "\A3\ui_f\data\map\markers\nato\o_inf.paa";
                    faction = "OPF_BlackOrder_F";
                    side = 0;
                    class Unit0 {
                    ...
                    class Unit1 {
                        ...
                        rank = "PRIVATE";
                        side = 0;
                        vehicle = "O_BlackOrder_Rifleman_Light_F";
                    };
                };
            };
        };
