        ...
        class OPF_BlackOrder_F {
            ...
            class Motorized_MTP {
				...
				class O_BlackOrder_MotInf_AA {
					...
					class Unit0 {
						side = 0;
						vehicle = "O_blackorder_veh_m998_2dr_F";
						rank = "SERGEANT";
						position[] = {0,0,0};
					};
					class Unit1 {
				...
				class O_BlackOrder_MotInf_MGTeam {
				...
				class O_BlackOrder_MotInf_GMGTeam {
					...
					class Unit0 {
						side = 0;
						vehicle = "O_blackorder_veh_m1025_mk19_F";
						rank = "SERGEANT";
						position[] = {0,0,0};
					};
					class Unit1 {
                ...
                class O_BlackOrder_MotInf_Reinforce {
                    ...
                    class Unit0 {
                        ...
                        rank = "SERGEANT";
                        side = 0;
                        vehicle = "O_blackorder_veh_Truck_Transport_F";
                    };
                    class Unit1 {
                        position[] = {5,0,0};
                        rank = "SERGEANT";
